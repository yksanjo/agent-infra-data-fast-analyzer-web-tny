# agent-infra-data-fast-analyzer-web-tny

## Detailed Description

agent-infra-data-fast-analyzer-web-tny is a infrastructure-focused project that evaluates service health and change events to reduce operational risk.  
